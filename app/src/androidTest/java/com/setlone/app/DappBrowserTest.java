...
import static com.setlone.app.steps.Steps.navigateToBrowser;
import static com.setlone.app.steps.Steps.openOptionsMenu;
import static com.setlone.app.steps.Steps.selectTestNet;
import static com.setlone.app.util.Helper.click;
import static com.setlone.app.util.Helper.waitUntilLoaded;
...
public class DappBrowserTest extends BaseE2ETest
{
    ...
    public void should_suggest_websites()
    {
        ...
        Helper.wait(2);
        assertUrlContains("setlone.app.entity.DApp@");
    }
