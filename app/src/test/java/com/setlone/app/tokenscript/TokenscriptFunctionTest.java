package com.setlone.app.tokenscript;
...
import static com.setlone.token.tools.TokenDefinition.TOKENSCRIPT_MINIMUM_SCHEMA;
...
public class TokenscriptFunctionTest implements ParseResult {
    ...
    private final String entryTokenTestFile = "<ts:token xmlns:ethereum=\"urn:ethereum:constantinople\" xmlns:ts=\"http://tokenscript.org/2020/06/tokenscript\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" custodian=\"false\" xsi:schemaLocation=\"http://tokenscript.org/2020/06/tokenscript http://tokenscript.org/2020/06/tokenscript.xsd\">\n" +
            ...
            "      <ts:string quantity=\"one\">?�場??/ts:string>\n" +
            "      <ts:string quantity=\"other\">?�場??/ts:string>\n" +
            "    </ts:plurals>\n" +
            "  </ts:label>\n" +
            ...
            "        </ts:plurals>\n" +
            "        <ts:string xml:lang=\"zh\">已经过期?�票</ts:string>\n" +
            "      </ts:label>\n" +
            "    </ts:selection>\n" +
            "  <ts:cards>\n" +
            "    <ts:card type=\"token\">\n" +
            ...
            "</style>\n" +
            "        <body><div>\n" +
            "    <!-- Iconified view displayed on the first page when clicking on token card in SetlOne -->\n" +
            ...
            "        <ts:string xml:lang=\"zh\">?�場</ts:string>\n" +
            ...
            "        <ts:string xml:lang=\"zh\">?�间</ts:string>\n" +
            "      </ts:label>\n" +
            "      <ts:origins>\n" +
