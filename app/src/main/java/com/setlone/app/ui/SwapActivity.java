...
import com.setlone.app.entity.analytics.TokenSwapEvent;
import com.setlone.app.entity.lifi.Chain;
import com.setlone.app.entity.lifi.Connection;
...
import com.setlone.app.ui.widget.entity.ProgressInfo;
import com.setlone.app.util.BalanceUtils;
import com.setlone.app.util.SwapUtils;
import com.setlone.app.viewmodel.SwapViewModel;
import com.setlone.app.viewmodel.Tokens;
...
import com.setlone.app.widget.SelectTokenDialog;
...
public class SwapActivity extends BaseActivity implements StandardFunctionInterface, ActionSheetCallback
{
    ...
    private com.setlone.app.entity.tokens.Token token;
    ...
    private ActionSheetDialog createConfirmationAction(Quote quote)
    {
        ...
        try
        {
            com.setlone.app.entity.tokens.Token activeToken = viewModel.getTokensService().getTokenOrBase(sourceToken.chainId, sourceToken.address);
