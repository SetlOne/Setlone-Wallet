...
import com.setlone.app.util.ShortcutUtils;
import com.setlone.app.viewmodel.DappBrowserViewModel;
import com.setlone.app.viewmodel.TokenFunctionViewModel;
        ...
        OnEthCallListener, OnWalletAddEthereumChainObjectListener, OnWalletActionListener
{
    ...
    {
        chainId = getIntent().getLongExtra(C.EXTRA_CHAIN_ID, com.setlone.ethereum.EthereumNetworkBase.MAINNET_ID);
