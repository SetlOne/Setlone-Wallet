...
public class DappBrowserUtils
{
    ...
    private static final String DEFAULT_HOMEPAGE = "https://setlone.com/";
    private static final String POLYGON_HOMEPAGE = "https://setlone.com/browser-item-category/polygon/";
