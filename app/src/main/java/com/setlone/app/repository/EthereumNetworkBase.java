...
import static com.setlone.app.entity.EventSync.BLOCK_SEARCH_INTERVAL;
import static com.setlone.app.entity.EventSync.OKX_BLOCK_SEARCH_INTERVAL;
import static com.setlone.app.entity.EventSync.POLYGON_BLOCK_SEARCH_INTERVAL;
import static com.setlone.app.util.Utils.isValidUrl;
import static com.setlone.ethereum.EthereumNetworkBase.AMOY_TEST_RPC_URL;
import static com.setlone.ethereum.EthereumNetworkBase.ARBITRUM_TEST_ID;
import static com.setlone.ethereum.EthereumNetworkBase.ARBITRUM_MAIN_ID;
import static com.setlone.ethereum.EthereumNetworkBase.AURORA_MAINNET_ID;
import static com.setlone.ethereum.EthereumNetworkBase.AURORA_TESTNET_ID;
import static com.setlone.ethereum.EthereumNetworkBase.AVALANCHE_ID;
import static com.setlone.ethereum.EthereumNetworkBase.BASE_FREE_MAINNET_RPC;
import static com.setlone.ethereum.EthereumNetworkBase.BASE_FREE_TESTNET_RPC;
import static com.setlone.ethereum.EthereumNetworkBase.BASE_MAINNET_ID;
import static com.setlone.ethereum.EthereumNetworkBase.BASE_TESTNET_ID;
import static com.setlone.ethereum.EthereumNetworkBase.BINANCE_MAIN_ID;
import static com.setlone.ethereum.EthereumNetworkBase.BINANCE_TEST_ID;
import static com.setlone.ethereum.EthereumNetworkBase.CLASSIC_ID;
import static com.setlone.ethereum.EthereumNetworkBase.CRONOS_MAIN_ID;
import static com.setlone.ethereum.EthereumNetworkBase.CRONOS_TEST_ID;
import static com.setlone.ethereum.EthereumNetworkBase.FANTOM_ID;
import static com.setlone.ethereum.EthereumNetworkBase.FANTOM_TEST_ID;
import static com.setlone.ethereum.EthereumNetworkBase.FUJI_TEST_ID;
import static com.setlone.ethereum.EthereumNetworkBase.GNOSIS_ID;
import static com.setlone.ethereum.EthereumNetworkBase.GOERLI_ID;
import static com.setlone.ethereum.EthereumNetworkBase.HOLESKY_ID;
import static com.setlone.ethereum.EthereumNetworkBase.IOTEX_MAINNET_ID;
import static com.setlone.ethereum.EthereumNetworkBase.IOTEX_TESTNET_ID;
import static com.setlone.ethereum.EthereumNetworkBase.KLAYTN_BAOBAB_ID;
import static com.setlone.ethereum.EthereumNetworkBase.KLAYTN_ID;
import static com.setlone.ethereum.EthereumNetworkBase.LINEA_ID;
import static com.setlone.ethereum.EthereumNetworkBase.LINEA_TEST_FREE_RPC;
import static com.setlone.ethereum.EthereumNetworkBase.LINEA_TEST_ID;
import static com.setlone.ethereum.EthereumNetworkBase.MAINNET_ID;
import static com.setlone.ethereum.EthereumNetworkBase.MANTLE_MAINNET_ID;
import static com.setlone.ethereum.EthereumNetworkBase.MANTLE_TESTNET_ID;
import static com.setlone.ethereum.EthereumNetworkBase.MILKOMEDA_C1_ID;
...
import static com.setlone.ethereum.EthereumNetworkBase.PALM_TEST_ID;
import static com.setlone.ethereum.EthereumNetworkBase.POLYGON_AMOY_ID;
import static com.setlone.ethereum.EthereumNetworkBase.POLYGON_ID;
import static com.setlone.ethereum.EthereumNetworkBase.POLYGON_TEST_ID;
import static com.setlone.ethereum.EthereumNetworkBase.ROOTSTOCK_MAINNET_ID;
import static com.setlone.ethereum.EthereumNetworkBase.ROOTSTOCK_TESTNET_ID;
import static com.setlone.ethereum.EthereumNetworkBase.SEPOLIA_TESTNET_ID;
import static com.setlone.ethereum.EthereumNetworkBase.SEPOLIA_TESTNET_RPC_URL;
...
public abstract class EthereumNetworkBase implements EthereumNetworkRepositoryType
{
    ...
    static
    {
        ...
        // TRON 네트워크 설정
        // 주의: TRON은 EVM 호환 네트워크가 아니므로 JSON-RPC를 사용하지 않습니다.
    ...
    {
        {
            ...
            // 1. Chain ID 728126428은 메타데이터용이며, 실제로는 CoinType.TRON (195) 사용
            // 2. RPC URL은 HTTP API 엔드포인트 (JSON-RPC 아님)
    ...
    /**
     * TRON 네트워크 리스트 추가
     * TRON은 EVM 호환이 아니므로 별도 섹션으로 관리
     */
    private void addTronNetworks(List<NetworkInfo> result)
    {
        for (long networkId : tronNetworkList)
        {
            NetworkInfo network = networkMap.get(networkId);
    ...
    public List<Long> getSelectedFilters()
    {
        ...
        for (Long networkId : storedIds)
        {
            ...
            if (check != null && !selectedIds.contains(networkId))
            {
    ...
    public NetworkInfo[] getAvailableNetworkList()
    {
        ...
        // TRON 네트워크는 별도 섹션으로 추가 (EVM 호환이 아니므로)
        addTronNetworks(networks);
    ...
    /**
     * TRON 네트워크인지 확인
     * TRON은 EVM 호환이 아니므로 별도 관리
     */
    public static boolean isTronNetwork(long chainId)
    {
        return tronNetworkList.contains(chainId);
    }
     ...
     * TRON 네트워크 리스트
     */
    public static List<Long> getTronNetworks()
    {
        return tronNetworkList;
    }
