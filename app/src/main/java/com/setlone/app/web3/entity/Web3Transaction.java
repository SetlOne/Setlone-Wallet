package com.setlone.app.web3.entity;
...
import com.setlone.app.util.StyledStringBuilder;
...
public class Web3Transaction implements Parcelable
{
     ...
     * @param minGas
     */
    public Web3Transaction(com.setlone.app.entity.Transaction tx, ActionSheetMode mode, BigInteger minGas)
    {
