...
import static com.setlone.token.tools.TokenDefinition.Syntax.IA5String;
...
public class TokenScriptResult
{
    public static final class Attribute {
        ...
        public Attribute(com.setlone.token.entity.Attribute attr, BigInteger value, String text)
        {
            this.id = attr.name;
