...
import com.setlone.token.util.DateTime;
import com.setlone.token.util.DateTimeFactory;
        ...
        switch (getAs())
        {
            ...
            case Mapping:
                ...
                else
                {
                    ...
                    //refer to 'SetlOne meetup indices' where 'Match' mapping is null but for FIFA is not.
