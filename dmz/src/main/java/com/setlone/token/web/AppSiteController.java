package com.setlone.token.web;

import static com.setlone.token.tools.Convert.getEthString;
import static com.setlone.token.tools.ParseMagicLink.normal;
import static com.setlone.token.web.Ethereum.TokenscriptFunction.ZERO_ADDRESS;
...
import com.setlone.token.web.Ethereum.TokenscriptFunction;
import com.setlone.token.web.Ethereum.TransactionHandler;
import com.setlone.token.web.Service.CryptoFunctions;
...
public class AppSiteController implements AttributeInterface
{
    ...
    private static final String appleAssociationConfig = "{\n" +
            ...
            "    \"details\": [\n" +
            "      {\n" +
            "        \"appID\": \"LRAW5PL536.com.stormbird.setlone\",\n" +
            "        \"paths\": [ \"*\" ]\n" +
            "      }\n" +
            "    ]\n" +
            "  }\n" +
    ...
    public RedirectView home(RedirectAttributes attributes){
        return new RedirectView("http://setlone.com");
    }
            ...
            throws IOException, SAXException, NoHandlerFoundException
    {
        ...
        {
            return "If you are using SetlOne with WalletConnect and facing issues please take the following steps:<br/><br/>\nTry using WalletConnect V2 (or latest version)<br/>\nTry launching the application from within SetlOne app's Browser tab.<br/>";
        }
